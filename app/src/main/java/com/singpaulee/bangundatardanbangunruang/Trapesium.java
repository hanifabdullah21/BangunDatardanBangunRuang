...
public class Trapesium extends AppCompatActivity {
        ...
        switch(id){
            ...
            case R.id.bantuanmenu:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Pada halaman ini disediakan materi-materi tentang TRAPESIUM.\n"+
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtv_sub = (TextView) findViewById(R.id.tv_subtra);
        mline_sub = (LinearLayout) findViewById(R.id.line_subtra);
        mtv_rum = (TextView) findViewById(R.id.tv_rumtra);
        mline_rum = (LinearLayout) findViewById(R.id.line_rumtra);
        mtv_con = (TextView) findViewById(R.id.tv_contra);
        mline_con = (LinearLayout) findViewById(R.id.line_contra);

        //setting toolbar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_tra);
