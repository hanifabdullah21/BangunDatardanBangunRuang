...
public class kubus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtv_sub = (TextView) findViewById(R.id.tv_subkbs);
        mline_sub = (LinearLayout) findViewById(R.id.line_subkbs);
        mtv_rum = (TextView) findViewById(R.id.tv_rumkbs);
        mline_rum = (LinearLayout) findViewById(R.id.line_rumkbs);
        mtv_con = (TextView) findViewById(R.id.tv_conkbs);
        mline_con = (LinearLayout) findViewById(R.id.line_conkbs);

        //setting toolbar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_kbs);
