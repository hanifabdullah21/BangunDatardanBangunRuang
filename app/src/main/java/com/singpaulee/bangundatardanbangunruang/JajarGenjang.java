...
public class JajarGenjang extends AppCompatActivity {
        ...
        switch(id){
            ...
            case R.id.bantuanmenu:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Pada halaman ini disediakan materi-materi tentang JAJAR GENJANG.\n"+
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtv_sub = (TextView) findViewById(R.id.tv_subjg);
        mline_sub = (LinearLayout) findViewById(R.id.line_subjg);
        mtv_rum = (TextView) findViewById(R.id.tv_rumjg);
        mline_rum = (LinearLayout) findViewById(R.id.line_rumjg);
        mtv_con = (TextView) findViewById(R.id.tv_conjg);
        mline_con = (LinearLayout) findViewById(R.id.line_conjg);

        //setting toolbar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_jg);
