...
public class Balok extends AppCompatActivity {
        ...
        switch(id){
            ...
            case R.id.bantuanmenu:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Pada halaman ini disediakan materi-materi tentang BELAH KETUPAT.\n"+
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtv_sub = (TextView) findViewById(R.id.tv_subblk);
        mline_sub = (LinearLayout) findViewById(R.id.line_subblk);
        mtv_rum = (TextView) findViewById(R.id.tv_rumblk);
        mline_rum = (LinearLayout) findViewById(R.id.line_rumblk);
        mtv_con = (TextView) findViewById(R.id.tv_conblk);
        mline_con = (LinearLayout) findViewById(R.id.line_conblk);
        mline_sifat = (LinearLayout) findViewById(R.id.line_sifatBalok);


        //setting toolbar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_blk);
        ...
        if (showingFirst==true){
            ...
            mline_sifat.setVisibility(View.VISIBLE);
            ...
            mline_sifat.setVisibility(View.GONE);
//            params3.height = 110;
//            mline_sub.setLayoutParams(params3);
            showingFirst =true;
        }
