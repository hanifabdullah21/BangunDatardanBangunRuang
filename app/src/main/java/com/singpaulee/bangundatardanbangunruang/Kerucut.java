...
public class Kerucut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtv_sub = (TextView) findViewById(R.id.tv_subkrct);
        mline_sub = (LinearLayout) findViewById(R.id.line_subkrct);
        mtv_rum = (TextView) findViewById(R.id.tv_rumkrct);
        mline_rum = (LinearLayout) findViewById(R.id.line_rumkrct);
        mtv_con = (TextView) findViewById(R.id.tv_conkrct);
        mline_con = (LinearLayout) findViewById(R.id.line_conkrct);

        //setting toolbar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_krct);
