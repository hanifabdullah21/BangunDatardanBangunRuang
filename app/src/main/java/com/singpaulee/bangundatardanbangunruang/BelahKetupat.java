...
public class BelahKetupat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtv_sub = (TextView) findViewById(R.id.tv_subbk);
        mline_sub = (LinearLayout) findViewById(R.id.line_subbk);
        mtv_rum = (TextView) findViewById(R.id.tv_rumbk);
        mline_rum = (LinearLayout) findViewById(R.id.line_rumbk);
        mtv_con = (TextView) findViewById(R.id.tv_conbk);
        mline_con = (LinearLayout) findViewById(R.id.line_conbk);
