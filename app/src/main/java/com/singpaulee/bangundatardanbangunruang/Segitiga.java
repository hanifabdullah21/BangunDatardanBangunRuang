...
public class Segitiga extends AppCompatActivity {
        ...
        switch(id){
            ...
            case R.id.bantuanmenu:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Pada halaman ini disediakan materi-materi tentang SEGITIGA.\n"+
                                "Pengguna dapat membuka dan menutupnya kembali dengan menekan sub judul di bawah gambar bangun"+
                                "Pada bagian gambar pengguna dapat menggeser gambar secara horizontal untuk melihat gambar segitiga yang lain.")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtv_sub = (TextView) findViewById(R.id.tv_subseg);
        mline_sub = (LinearLayout) findViewById(R.id.line_subseg);
        mtv_rum = (TextView) findViewById(R.id.tv_rumseg);
        mline_rum = (LinearLayout) findViewById(R.id.line_rumseg);
        mtv_con = (TextView) findViewById(R.id.tv_conseg);
        mline_con = (LinearLayout) findViewById(R.id.line_conseg);

        //setting toolbar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_seg);
