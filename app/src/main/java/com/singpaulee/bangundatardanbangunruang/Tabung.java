...
public class Tabung extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtv_sub = (TextView) findViewById(R.id.tv_subtbng);
        mline_sub = (LinearLayout) findViewById(R.id.line_subtbng);
        mtv_rum = (TextView) findViewById(R.id.tv_rumtbng);
        mline_rum = (LinearLayout) findViewById(R.id.line_rumtbng);
        mtv_con = (TextView) findViewById(R.id.tv_contbng);
        mline_con = (LinearLayout) findViewById(R.id.line_contbng);

        //setting toolbar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_tbng);
