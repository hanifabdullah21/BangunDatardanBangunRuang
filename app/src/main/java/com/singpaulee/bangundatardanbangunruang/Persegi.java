...
public class Persegi extends AppCompatActivity {
        ...
        switch(id){
            ...
            case R.id.bantuanmenu:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Pada halaman ini disediakan materi-materi tentang PERSEGI.\n"+
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtv_sub = (TextView) findViewById(R.id.tv_subper);
        mline_sub = (LinearLayout) findViewById(R.id.line_subper);
        mtv_rum = (TextView) findViewById(R.id.tv_rumper);
        mline_rum = (LinearLayout) findViewById(R.id.line_rumper);
        mtv_con = (TextView) findViewById(R.id.tv_conper);
        mline_con = (LinearLayout) findViewById(R.id.line_conper);

        //setting toolbar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_per);
