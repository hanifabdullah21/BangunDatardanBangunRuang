...
public class PersegiPanjang extends AppCompatActivity {
        ...
        switch(id){
            ...
            case R.id.bantuanmenu:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Pada halaman ini disediakan materi-materi tentang PERSEGI PANJANG.\n"+
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtv_sub = (TextView) findViewById(R.id.tv_subpan);
        mline_sub = (LinearLayout) findViewById(R.id.line_subpan);
        mtv_rum = (TextView) findViewById(R.id.tv_rumpan);
        mline_rum = (LinearLayout) findViewById(R.id.line_rumpan);
        mtv_con = (TextView) findViewById(R.id.tv_conpan);
        mline_con = (LinearLayout) findViewById(R.id.line_conpan);

        //setting toolbar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_pan);
