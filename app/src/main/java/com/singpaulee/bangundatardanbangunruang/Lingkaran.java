...
public class Lingkaran extends AppCompatActivity {
        ...
        switch(id){
            ...
            case R.id.bantuanmenu:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Pada halaman ini disediakan materi-materi tentang LINGKARAN.\n"+
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtv_sub = (TextView) findViewById(R.id.tv_subl);
        mline_sub = (LinearLayout) findViewById(R.id.line_subl);
        mtv_rum = (TextView) findViewById(R.id.tv_ruml);
        mline_rum = (LinearLayout) findViewById(R.id.line_ruml);
        mtv_con = (TextView) findViewById(R.id.tv_conl);
        mline_con = (LinearLayout) findViewById(R.id.line_conl);
