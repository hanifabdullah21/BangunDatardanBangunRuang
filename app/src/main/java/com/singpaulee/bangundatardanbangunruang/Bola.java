...
public class Bola extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtv_sub = (TextView) findViewById(R.id.tv_subbl);
        mline_sub = (LinearLayout) findViewById(R.id.line_subbl);
        mtv_rum = (TextView) findViewById(R.id.tv_rumbl);
        mline_rum = (LinearLayout) findViewById(R.id.line_rumbl);
        mtv_con = (TextView) findViewById(R.id.tv_conbl);
        mline_con = (LinearLayout) findViewById(R.id.line_conbl);

        //setting toolbar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_bl);
